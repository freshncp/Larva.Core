...
namespace Larva.Core.Tests
{
    public class ConfigurationManagerTests
    {
        ...
        public void TestMemoryConfigSetWithNotOverride()
        {
            ...
            Assert.Equal("value1", ConfigurationManager.Instance.Get("key1"));
        }
        ...
        public void TestMemoryConfigSetWithOverride()
        {
            ...
            Assert.Equal("value2", ConfigurationManager.Instance.Get("key1"));
        }
        ...
        public void TestMemoryConfigSetSectionWithNotOverride()
        {
            ...
            Assert.Equal(section1, ConfigurationManager.Instance.GetSection("section1"));
        }
        ...
        public void TestMemoryConfigSetSectionWithOverride()
        {
            ...
            Assert.Equal(section2, ConfigurationManager.Instance.GetSection("section1"));
        }
